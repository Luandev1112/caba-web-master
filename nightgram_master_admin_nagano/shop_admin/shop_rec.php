...
?>
							<p><span>待遇</span>
								...
								<label style="vertical-align: middle"><input type="checkbox" name="rec4c" class="checkbox-input" value="on" <?php echo $rec4_check4; ?>><span class="checkbox-parts">レンタル衣装あ</span></label>
