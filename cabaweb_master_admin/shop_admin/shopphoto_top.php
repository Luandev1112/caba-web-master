...
$result=mysqli_query($sql, "SELECT * From `data_top` WHERE `name2` = '$name2'");
while($row=mysqli_fetch_assoc($result)){
				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						<div class="attention_1">
							...
							<br />
							TOP表示のROOM数は最大4ROOMまで登録できます。
						</div>
						<form action="shopphoto_top_check.php" method="post" id="form" enctype="multipart/form-data">
