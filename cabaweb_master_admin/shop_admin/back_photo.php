...
<html lang="ja"><head>
<meta charset="utf-8">
<title>店舗トップ 静止画像設定｜Admin Tool</title>
<meta name="description" content="管理画面ツール　店舗トップ 静止画像設定">
				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<div class="slider_caution">
							...
							<span class="slider_caution_sub">PC版【横：2000px　縦：800px】</span><br />
							<span class="slider_caution_sub">スマホ版【横：800px　縦：1200px】</span><br />
							<span class="slider_caution_sub_2">必ず推奨サイズでアップして下さい。</span>
						</div>
						<form action="back_photo_check.php" method="post" id="form" enctype="multipart/form-data">
							<table>
									<tr>
										<td class="t_castgallery">
											<div class="castphoto_number">PC版</div>
											<?php
if ($photo1 == $empty) {
...
?>
									...
									<tr>
										<td class="t_castgallery">
											<div class="castphoto_number">スマホ版</div>
											<?php
if ($photo2 == $empty) {
	echo '<img src="" data-src="img/nophoto_1.jpg" class="lozad castphoto_contain"><br />';
} else {
