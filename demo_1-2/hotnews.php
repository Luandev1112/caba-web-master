			...
			<div class="page_base_area">
				<div class="top_contents_in">
					<div class="news_page_base">
						<span id="5" class="link"></span>
						<div class="news_page_box">
							<a href="img/top1.jpg" data-fancybox="" data-caption="">
								<div class="photo_thumbs"><img src="" data-src="img/top7.jpg" class="lozad"></div>
							</a>
							<div class="news_page_box_title">お知らせ</div>
							<div class="news_page_box_naiyou">
								新型コロナウイルス感染拡大防止に伴う営業自粛のお知らせ。<br />
								○月○日（○）～○月○日（○）まで臨時休業させていただく事になりました。<br />
								<br />
								○月○日（○）以降の営業に関しましてはホームページやSNSにておしらせ致します。<br />
							</div>
						</div>
