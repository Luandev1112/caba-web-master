...
?>
							<p><span>待遇</span>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4" class="checkbox-input" value="on" <?php echo $rec4_check1; ?>><span class="checkbox-parts">未経験大歓迎</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4a" class="checkbox-input" value="on" <?php echo $rec4_check2; ?>><span class="checkbox-parts">日払い有り</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4b" class="checkbox-input" value="on" <?php echo $rec4_check3; ?>><span class="checkbox-parts">送迎あり</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4c" class="checkbox-input" value="on" <?php echo $rec4_check4; ?>><span class="checkbox-parts">駐車場あり</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4d" class="checkbox-input" value="on" <?php echo $rec4_check5; ?>><span class="checkbox-parts">自由出勤</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4e" class="checkbox-input" value="on" <?php echo $rec4_check6; ?>><span class="checkbox-parts">ドレス貸与</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4f" class="checkbox-input" value="on" <?php echo $rec4_check7; ?>><span class="checkbox-parts">スタイリスト完備</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4g" class="checkbox-input" value="on" <?php echo $rec4_check8; ?>><span class="checkbox-parts">寮完備</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4h" class="checkbox-input" value="on" <?php echo $rec4_check9; ?>><span class="checkbox-parts">託児所完備</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4i" class="checkbox-input" value="on" <?php echo $rec4_check10; ?>><span class="checkbox-parts">ノータッチ・ノーピンク</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4j" class="checkbox-input" value="on" <?php echo $rec4_check11; ?>><span class="checkbox-parts">ノルマなし</span></label>
								<label style="vertical-align: middle"><input type="checkbox" name="rec4k" class="checkbox-input" value="on" <?php echo $rec4_check12; ?>><span class="checkbox-parts">イジメ・派閥なし</span></label>								
							</p>
