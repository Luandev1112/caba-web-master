			...
			<header role="banner">
				...
				<nav class="drawer-nav" role="navigation">
					<ul class="drawer-menu">				
						<li class="drawer-brand_first"><a class="drawer-brand" href="index.php?no=<?php echo $no; ?>" title="ショップトップ">ホーム</a></li>							
				...
				<div class="page_base_in">
					<div class="top_portal_box">
						...
						<div class="button_area_1">
							<a href="portal.php?no=<?php echo $no; ?>" class="btn_portal">ナイトグラム<br />説明書</a>
						</div>
					</div>					
...
?>
					...
					<div class="page_base_box">
						...
						<div class="wrapper_news_top">
							<?php
							 $result=mysqli_query($sql2, "SELECT * From `news` WHERE (sort>='$news_today' or sort='') AND blank='$data5' AND link='1' ORDER by sort_order LIMIT 4");
$cnt=mysqli_num_rows($result);
while($row=mysqli_fetch_assoc($result)){
//include('parts/basic_hensu.php');
