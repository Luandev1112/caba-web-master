...
$result=mysqli_query($sql2, "SELECT * From `news` WHERE (sort>='$news_today' or sort='') AND blank='$login_id' AND link='1' ORDER by sort_order LIMIT 1");
...
<body>
	<div id="top_fade">
		<div class="drawer drawer--left">
			...
			<div id="page_base">
				<h2><?php echo $s_name; ?><br /><span style="font-size: 70%;">ニュース確認</span></h2>
