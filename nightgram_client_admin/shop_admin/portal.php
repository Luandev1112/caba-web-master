					...
					<div class="portal_page_base">
						...
						<div class="portal_box">
							...
							<div class="portal_box_naiyou">
								<ul>
									<li>
										イベント情報・求人情報・休業日などナイトグラムユーザーに投稿できます。
									</li>
									<li>
										最大10項目まで投稿可能です。
									</li>
									<li>
										最新のNEWSはナイトグラムエリアトップに表示されます。
									</li>
									<li>
										投稿したNEWSは編集削除出来ます。
									</li>
							...
							<div class="portal_box_naiyou">
								<ul>
									<li>
										割引クーポンやドリンクサービスなどナイトグラムユーザーに投稿できます。
									</li>
									<li>
										投稿数は無制限です。
									</li>
						...
						<div class="portal_box">
							<div class="portal_box_naiyou">
								<ul>
									<li>
										お店の基本情報や求人情報を変更する際には運営までご連絡ください。
									</li>
									<li>
										店舗サムネイルや求人画像のデザインや内容を変更する場合は運営までご連絡下さい。
									</li>
									<li>
										...
										データ形式：JPG<br />
										<span style="color: #FF0000">
										※データ入稿する場合<br />店舗サムネイルはロゴを中心にしたデザイン<br />求人画像は特に規定はございません。</span>
									</li>
								</ul>
							</div>							
						</div>
