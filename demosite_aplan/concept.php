...
<div class="page_base_area">
  <div class="page_base">
    ...
    <div class="concept_page_top">
      <img src="img/top1.jpg">
    </div>
    <div class="concept_page_title">優雅なひとときを…</div>
    <div class="concept_page_naiyou">
    club MONOはホテルのラウンジをコンセプトにしております。<br >
    お客様にゆったりと優雅な空間をあじわっていただきたく内装をこだわりました。<br />
    <br />
    他店では珍しいプライベート空間もご用意しております。<br />
    <br />
    プライベート空間では完全個室の予約優先ルームとなっております。<br />
    接待や団体様に人気となっています。<br />
    <br />
    詳細はお気軽にお問合せ下さい。<br />
    </div>
