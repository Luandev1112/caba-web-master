...
<div class="rec_page_area">
  <div class="page_base">
    <div class="rec_page_box">
      <div class="rec_page_box_img"><img src="img/top2.jpg"></div>
      <div class="rec_page_title">給与</div>
      <div class="rec_page_pay_1"><span class="rec_page_pay_2">体験時給</span> 1,500<span class="rec_page_pay_2">円～</span></div>
      <div class="rec_page_pay_1-2"><span class="rec_page_pay_2-2">最低保証時給</span> 1,200<span class="rec_page_pay_2-2">円～</span></div>
...
<div class="rec_page_message_area">
  <div class="page_base">
    <div class="rec_page_box">
      ...
      <br />
      もしろん経験者の方も大歓迎です!!<br />
      他店から移籍する場合は以前のお店より良い待遇をご用意してます。<br />
      </div>
      
      <div class="wrapper">
        <div class="element_rec">
          <div class="rec_page_message_box">
          <div class="rec_page_message_box_img"><img src="img/rec_1.jpg"></div>
        ...
        <div class="element_rec">
          <div class="rec_page_message_box">
          <div class="rec_page_message_box_img"><img src="img/rec_2.jpg"></div>
    ...
    <div class="rec_page_box">
      ...
      <div class="wrapper_2">
        <div class="element_taigu">
          ...
          <img src="img/taiguu-1.svg">
          <div class="rec_taiguu_box_txt">衣装レンタル</div>
        ...
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-2.svg">
          <div class="rec_taiguu_box_txt">寮完備</div>
          <div class="rec_taiguu_box_naiyou">
          即入寮可能の寮を完備しています。
          </div>
          </div>
        ...
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-3.svg">
          <div class="rec_taiguu_box_txt">自由出勤</div>
          <div class="rec_taiguu_box_naiyou">
          自分の決めた時間に出勤出来ます。
          </div>
          </div>
        ...
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-4.svg">
          <div class="rec_taiguu_box_txt">ヘアメイク有り</div>
          <div class="rec_taiguu_box_naiyou">
          プロのスタイリストさんを完備しています。
          </div>
          </div>
        ...
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-5.svg">
          <div class="rec_taiguu_box_txt">託児所完備</div>
          <div class="rec_taiguu_box_naiyou">
          お子様がいるママさんも安心して働けます。
          </div>
          </div>
        ...
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-7.svg">
          <div class="rec_taiguu_box_txt">ノータッチ・ノーピンク</div>
          <div class="rec_taiguu_box_naiyou">
          当店はノータッチ・ノーピンクに厳しいお店だから安心して下さい。
          </div>
          </div>
        </div><!--element_service-->
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-8.svg">
          <div class="rec_taiguu_box_txt">担当マネージャー制</div>
          <div class="rec_taiguu_box_naiyou">
          担当マネージャーが貴女を徹底的にサポート致します。
          </div>
          </div>
        </div><!--element_service-->
        <div class="element_taigu">
          <div class="rec_taiguu_box">
          <img src="img/taiguu-10.svg">
...
<div class="rec_page_staff_area">
  <div class="page_base">
    <div class="rec_page_box">
      <div class="rec_page_title">男子スタッフ大募集</div>

      <div class="rec_page_staff_pay_1"><span class="rec_page_staff_pay_2">初任給</span> 270,000<span class="rec_page_staff_pay_2">円</span></div>
      <div class="rec_page_staff_pay_1-2"><span class="rec_page_staff_pay_2-2">アルバイト 時給</span> 1,200<span class="rec_page_staff_pay_2-2">円</span></div>                  
      <div class="rec_page_pay_3">
      各種手当てあり
      </div>
      
      <div class="rec_page_staff_comment">
      ガールズバー運営スタッフ大募集中です!!<br />
      ガールズバーの店舗運営スタッフとして働いてみませんか？<br />
