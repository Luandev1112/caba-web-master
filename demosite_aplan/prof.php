        ...
        <div class="prof_page_gallery">
          <div class="wrapper_prof my-gallery">
            <figure class="element_prof_1">
              ...
              <img src="img/ai-1.jpg" class="img_border" alt="なお" />
              </a>
            </figure>
            <figure class="element_prof_1">
              <a href="img/ai-1.jpg" data-size="600x900">
...
if (window.matchMedia( "(min-width: 480px)" ).matches) {
    ...
    var feed1 = {
        "accesstoken": "c21hMTk5NTA4NTg3My4zYTgxYTlmLjE4NGI4YmRhM2M0YzQwMGViY2MyNTMzZWNhNTZiZGE5.Nzc3MTc0MzY5NDk5NA==.c2hid3d3LmNhYmEtd2ViLmNvbQ==", //Separate multiple Access Tokens with commas. Get your Access Token here: https://smashballoon.com/instagram-feed/standalone/token/
