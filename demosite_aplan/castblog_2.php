...
<div class="page_base_area">
  <div class="page_base">
    ...
    <div class="blog_page_cast_main">
      <div class="wrapper">
        <div class="element_blog_1">
          <div class="my-gallery_2">
            <figure>
            <a href="img/blog_1.jpg" data-size="900x600" title="">
            <div class="trimming_blog_2"><img src="img/blog_1.jpg"></div>
            </a>
            </figure>
          </div>        
        </div><!--element_blog_1-->
        <div class="element_blog_2">
          <div class="blog_page_cast_ymd">2018.10.10 / 20:35</div>
          <div class="blog_page_cast_naiyou">
