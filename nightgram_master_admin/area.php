...
if($search1!=""){
	$search1_sql=" AND toshi_area = ".$search1."";
}else{
	$search1_sql="";
}
...
<body>
				...
				<div class="page_base_in">
					...
					<div class="page_base_box_2">				
						...
						<div class="client_search">
							<form action="area.php" method="get" id="form">
								<div class="wrapper_2">
	...
	<option value="6">新潟エリア</option>
		...
		<option value="13">愛知エリア</option>
						...
						<div class="wrapper">
							<?php
$result=mysqli_query($sql, "SELECT * From `toshi_tb` WHERE toshi_id!='' ".$search1_sql." ORDER by toshi_id");
...
echo "<div class=\"client_area\">".$ken."県</div><div class=\"client_shop\">".$toshi_name."市</div>\n";

//写真登録・編集削除画面へ
echo <<<GOLGO
<div class="wrapper">
          <div class="element_news_a">
            <a href="area_edit.php?toshi_id=$toshi_id" class="btn_sub">街名編集</a>
          </div>         
          <div class="element_news_b">
            <a data-target="modal_delete_$toshi_id" class="btn_sub modal_open">削除</a>
          </div>
          </div>
            <!-- 削除モーダル1 -->
            <div id="modal_delete_$toshi_id" class="modal_box">          
              <p>
                <div class="modal_box_title">$toshi_nameを削除</div>
                <div class="cast_sakujyo">本当に削除しますか？</div>
                <div class="under_button_area_2"><a href="area_rewrite2.php?toshi_id=$toshi_id" class="formbtn_2">削除する</a></div>
              </p>
