...
//		array_splice($data , $i , 1);
		mysqli_query($sql2, "DELETE FROM `rss_information` WHERE id LIKE '$id' LIMIT 1");
	}
...
<meta http-equiv="refresh" content="0;URL=insta_photo.php?search1=<?php echo $option23; ?>&search2=<?php echo $option24; ?>&search3=<?php echo $option20; ?>">
<title></title>
</head>
