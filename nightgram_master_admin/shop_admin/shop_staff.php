				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<form action="shop_staff_rewrite.php" method="post" id="form" >
							...
							<p>
								<label><span>メッセージ ③　本文</span><?php $staff1e = str_replace("<br />" , "\r\n" , $staff1e); ?><textarea name="staff1e" class="txtfiled" rows="10" placeholder="例）当店なら未経験大歓迎！お子さまのいるママさんも大歓迎です！"><?php echo $staff1e; ?></textarea></label>
							</p>
							<p>
