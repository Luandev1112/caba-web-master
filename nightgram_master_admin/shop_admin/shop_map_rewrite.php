...
//		array_splice($data , $i , 1 , $line);
		mysqli_query($sql, "UPDATE `shop_tb` SET `no`='$no',`map`='$map',`googleurl`='$googleurl' WHERE `no` LIKE '$no' LIMIT 1");
...
<meta http-equiv="refresh" content="0;URL=index.php?no=<?php echo $no; ?>">
<title></title>
</head>
