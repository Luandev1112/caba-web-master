...
<body>
	<div id="top_fade">
		<div class="drawer drawer--left">
			...
			<div id="page_base">
				<h2><?php echo $s_name; ?><br /><span style="font-size: 70%;">ニュース画像編集</span></h2>
							...
							<table>
								<tr>
									<td class="t_hot">
										...
										<?php
if ($photo1 == $empty) {
	echo '<img src="../img/nophoto_1.jpg" class="castphoto_contain" />';
} else {
...
if ($photo1 == $empty) {
	...
	echo "<div class=\"sakujyo_check\">
											<label><input type=\"checkbox\" name=\"delete\" class=\"checkbox-input\" value=\"delete\"><span class=\"checkbox-parts\">削除する</span></label>
										</div>	\n";
