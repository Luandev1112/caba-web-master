...
$result=mysqli_query($sql3, "SELECT * From `shop` WHERE `login_id` = '$blank'");
while($row=mysqli_fetch_assoc($result)){
...
<body>
	<div id="top_fade">
		<div class="drawer drawer--left">
			...
			<div id="page_base">
				<h2><?php echo $s_name; ?><br /><span style="font-size: 70%;">ニュース画像確認</span></h2>
...
//	}
//}
$data = mysqli_query($sql2, "SELECT * FROM `news` WHERE news_id LIKE '$news_id'");
...
//fclose($handle);
mysqli_query($sql2, "UPDATE `news` SET `photo1`='$photo1',`jpeg`='$jpeg',`photo_box`='$photo_box' WHERE `news_id` LIKE '$news_id' LIMIT 1");
