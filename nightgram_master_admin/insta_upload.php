...
//保存先のディレクトリ
$dir = 'photo/';
$dir2 = 'https://www.caba-web.com/nightgram_master_admin/photo/';
//拡張子
...
//	}
//}
$data = mysqli_query($sql2, "SELECT * FROM `rss_information` WHERE id LIKE '$id'");
while($row=mysqli_fetch_assoc($data)) {
include('parts/rss_info.php');
}


if ($photo_name1 != $empty) {$img_url = $dir2 . $id. '_1.jpg';}
...
//fclose($handle);
mysqli_query($sql2, "UPDATE `rss_information` SET `img_url`='$img_url' WHERE `id` LIKE '$id' LIMIT 1");


//写真を削除
if($delete1=='delete'){
	unlink('../photo/'.$id.'_1'.$jpeg.'');
	unlink('../photo/'.$id.'_1_m'.$jpeg.'');
...
<meta http-equiv="refresh" content="0;URL=insta_photo.php?search1=<?php echo $option23; ?>&search2=<?php echo $option24; ?>&search3=<?php echo $option20; ?>#<?php echo $id; ?>">
