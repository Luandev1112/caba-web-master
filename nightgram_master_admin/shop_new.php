				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<form action="shop_check.php" method="post" id="form">
							...
							<p>
								<label><span>店舗名フリガナ（<font color="#FF0000">必須</font>）</span><input pattern="^([ァ-ン]|ー)+$" title="全角カタカナでご入力ください。" type="text" name="s_name2" class="txtfiled" placeholder="店舗名フリガナ" required></label>
