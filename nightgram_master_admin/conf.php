...
//「''」内を変更。IDとパスワード設定
$log_id = 'nightgram';	//ログインID
$log_pass = 'gram37915';	//ログインパスワード
...
//「''」内を変更
$sql_server4 = 'mysql144.phy.lolipop.lan';	/* SQLサーバアドレス */
$sql_database4 = 'LAA0219176-demosite';	/* SQLデータベース名 */
...
if(! $sql4=mysqli_connect("$sql_server4", "$sql_user", "$sql_pass", "$sql_database4")) {print ("MySQL Connection Failed.\n"); exit;}

mysqli_set_charset($sql4, 'utf8mb4');  // procedural style
