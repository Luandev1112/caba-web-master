...
//写真を削除
if($delete1=='delete'){
	unlink('../client_admin/photo/'.$name2.'_1p.jpg');
	unlink('../client_admin/photo/'.$name2.'_1_mp.jpg');
	
	echo "<p>".$name."スライダー画像1枚目を削除しました。</p>\n";
}
if($delete2=='delete'){
	unlink('../client_admin/photo/'.$name2.'_2p.jpg');
	unlink('../client_admin/photo/'.$name2.'_2_mp.jpg');
		
	echo "<p>".$name."スライダー画像2枚目を削除しました。</p>\n";
}
if($delete3=='delete'){
	unlink('../client_admin/photo/'.$name2.'_3p.jpg');
	unlink('../client_admin/photo/'.$name2.'_3_mp.jpg');
		
	echo "<p>".$name."スライダー画像3枚目を削除しました。</p>\n";
}
if($delete4=='delete'){
	unlink('../client_admin/photo/'.$name2.'_4p.jpg');
	unlink('../client_admin/photo/'.$name2.'_4_mp.jpg');
		
	echo "<p>".$name."スライダー画像4枚目を削除しました。</p>\n";
}
if($delete5=='delete'){
	unlink('../client_admin/photo/'.$name2.'_5p.jpg');
	unlink('../client_admin/photo/'.$name2.'_5_mp.jpg');
		
	echo "<p>".$name."スライダー画像5枚目を削除しました。</p>\n";
}
if($delete6=='delete'){
	unlink('../client_admin/photo/'.$name2.'_6p.jpg');
	unlink('../client_admin/photo/'.$name2.'_6_mp.jpg');

	echo "<p>".$name."スライダー画像6枚目を削除しました。</p>\n";
}
if($delete7=='delete'){
	unlink('../client_admin/photo/'.$name2.'_7p.jpg');
	unlink('../client_admin/photo/'.$name2.'_7_mp.jpg');

	echo "<p>".$name."スライダー画像7枚目を削除しました。</p>\n";
}
if($delete8=='delete'){
	unlink('../client_admin/photo/'.$name2.'_8p.jpg');
	unlink('../client_admin/photo/'.$name2.'_8_mp.jpg');

	echo "<p>".$name."スライダー画像8枚目を削除しました。</p>\n";
}
if($delete9=='delete'){
	unlink('../client_admin/photo/'.$name2.'_9p.jpg');
	unlink('../client_admin/photo/'.$name2.'_9_mp.jpg');

	echo "<p>".$name."スライダー画像9枚目を削除しました。</p>\n";
}
if($delete10=='delete'){
	unlink('../client_admin/photo/'.$name2.'_10p.jpg');
	unlink('../client_admin/photo/'.$name2.'_10_mp.jpg');

	echo "<p>".$name."スライダー画像10枚目を削除しました。</p>\n";
}
	  if($delete11=='delete'){
	unlink('../client_admin/photo/'.$name2.'_11p.jpg');
	unlink('../client_admin/photo/'.$name2.'_11_mp.jpg');

	echo "<p>".$name."スライダー画像11枚目を削除しました。</p>\n";
}
	  if($delete12=='delete'){
	unlink('../client_admin/photo/'.$name2.'_12p.jpg');
	unlink('../client_admin/photo/'.$name2.'_12_mp.jpg');

	echo "<p>".$name."スライダー画像12枚目を削除しました。</p>\n";
}
	  if($delete13=='delete'){
	unlink('../client_admin/photo/'.$name2.'_13p.jpg');
	unlink('../client_admin/photo/'.$name2.'_13_mp.jpg');

	echo "<p>".$name."スライダー画像13枚目を削除しました。</p>\n";
}
	  if($delete14=='delete'){
	unlink('../client_admin/photo/'.$name2.'_14p.jpg');
	unlink('../client_admin/photo/'.$name2.'_14_mp.jpg');

	echo "<p>".$name."スライダー画像14枚目を削除しました。</p>\n";

}
	  if($delete15=='delete'){
	unlink('../client_admin/photo/'.$name2.'_15p.jpg');
	unlink('../client_admin/photo/'.$name2.'_15_mp.jpg');

	echo "<p>".$name."スライダー画像15枚目を削除しました。</p>\n";
}
	  if($delete16=='delete'){
	unlink('../client_admin/photo/'.$name2.'_16p.jpg');
	unlink('../client_admin/photo/'.$name2.'_16_mp.jpg');
