		...
		<div id="page_base">
			...
			<div class="page_base_in">
				...
				<div class="page_base_box_2">				
					...
					<form action="schedule.php?master_id=<?php echo $master_id; ?>" method="post"><input type="hidden" name="mode" value="write">
						<div class="wrapper">
							<?php
...
include('../cabaweb_master_admin/parts/starttime_conversion2.php');
//▽表示内容ここから
