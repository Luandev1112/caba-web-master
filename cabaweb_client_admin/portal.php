...
<div class="page_base_in">  
  ...
  <div class="page_base_box_2">
    <div class="portal_page_base">
      ...
      <div class="portal_box">
        <div class="portal_box_title">■掲載後のID（ユーザー名）設定の変更に関して</div>
        <div class="portal_box_naiyou">    
      ...
      <div class="portal_title">4.You Tubeについて</div>
      <div class="portal_box">
        <div class="portal_box_title">■連動するにあたり</div>
        <div class="portal_box_naiyou">
        You Tubeの登録にはチャンネルURLが必要になります。<br />
        </div>
      </div>
      ...
      <div class="portal_box">
        <div class="portal_box_title">■お店のご担当者様へ</div>
        <div class="portal_box_naiyou">    
        You Tubeチャンネルを登録するキャストさんに必ず確認してください。<br />
        <br />
        <span style="color: #000; font-size: 110%;">①投稿の確認</span><br />
        投稿がされていないと連携が出来ません。<br />
        <br />
        <span style="color: #000; font-size: 110%;">②公開されている動画</span><br />
        投稿した動画が公開されていないと連携が出来ません。<br />			
        </div>
      </div>    

      <div class="portal_title">5.キャストのYou Tube投稿について</div>
      <div class="portal_box">
        <div class="portal_box_title">■投稿するにあたり</div>
        <div class="portal_box_naiyou">
        ①基本的にはYou Tubeの規約に沿ってご活用下さい。<br />
        但し同業間やお客様など個人を特定できるような投稿は即時削除する場合がございます。<br />
        <br />
        ②お客様やキャスト間であっても他人が写っている場合は本人に投稿の可否を必ずご確認下さい。<br />
        <br />
        ③投稿でトラブルが生じた場合ナイトグラムでは一切責任を負いかねます。<br />
        <br />
        ④過度なトラブルやユーザーからの見過ごせないクレームを受けた場合は確認なく連携解除させていただきます。<br />
        </div>       
      </div>
      <div class="portal_box">
        <div class="portal_box_title">■投稿の時間差について</div>
        <div class="portal_box_naiyou">
        You Tubeで投稿した動画はナイトグラムに反映するまで最大30分前後の時間差が生じます。<br />
        </div>       
      </div> 		

      <div class="portal_title">6.店舗ページを更新したい場合</div>
      <div class="portal_box">
      ...
      <div class="portal_title">7.キャストの出勤情報</div>
      <div class="portal_box">
      ...
      <div class="portal_title">8.ショップニュース</div>
      <div class="portal_box">
        <div class="portal_box_title">■ナイトグラムとの連動</div>
        <div class="portal_box_naiyou">
        ナイトグラムのショップニュースはイベント情報・求人情報・店休日などをお店がダイレクトにお客様に配信できるコンテンツです。<br />
      ...
      <div class="portal_title">9.ランキングについて</div>
      <div class="portal_box">
      ...
      <div class="portal_title">10.サイト障害について</div>
      <div class="portal_box">
        <div class="portal_box_title">■各障害について</div>
        <div class="portal_box_naiyou">
        ①サーバ障害やアクセス障害などは起こる可能性がございます。<br />
        <br />
        ②ナイトグラムはInstagramとYou Tubeを使用して運営していますのでInstagramやYou Tubeに障害が起こった場合はナイトグラムも障害が起こる可能性がございます。<br />
        また、InstagramやYou Tubeの仕様が変更になった場合も障害が起こる可能性がございます。<br />
        <br />
        ③障害が2週間以上発生した場合のみ障害発生期間分の掲載期間の延長を致します。<br />
        <br />
        ④サーバー障害・システム障害・アクセス障害・Instagram障害・You Tube障害において掲載期間延長以外の責任は一切負いません。
        </div>
      </div>		
