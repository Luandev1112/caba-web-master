		...
		<div id="page_base">
			...
			<div class="page_base_in">
				<div class="page_base_box">
					<h3>新規ニュースを登録</h3>
					<div class="button_area_2"><a href="hotnews_new.php?master_id=<?php echo $master_id; ?>" class="btn_main">新規ニュース登録</a></div>
				</div>
...
echo "<div class=\"element_news\"><div class=\"top_news_box\"><div class=\"photo_thumbs\">\n";
	...
	echo "<img src=\"\" data-src=\"../cabaweb_master_admin/photo/nophoto_1.jpg\" class=\"lozad\" alt=\"\">\n";
		...
		if($photo_box == '1'){
	echo "<img src=\"https://www.caba-web.com/client_admin/".$photo1.".jpg?".$koshin."\" class=\"lozad\" />\n";
}elseif($photo_box == '3'){
	echo "<img src=\"https://www.nightgram.com/master_admin/".$photo1.".jpg?".$koshin."\" class=\"lozad\" />\n";
}elseif($photo_box == ''){
	echo "<img src=\"https://www.caba-web.com/client_admin/".$photo1.".jpg?".$koshin."\" class=\"lozad\" />\n";
}
