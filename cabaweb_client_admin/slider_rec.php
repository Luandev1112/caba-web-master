...
<html lang="ja"><head>
<meta charset="utf-8">
<title>キャスト求人 スライダー設定｜Admin Tool</title>
<meta name="description" content="管理画面ツール　キャスト求人 スライダー設定">
			...
			<div id="page_base">
				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<form action="slider_rec_check.php" method="post" id="form" enctype="multipart/form-data">
							<table>
								<tr>
