...
?>
      ...
      <option value="AB型"<?php echo $b_type4; ?>>AB型</option>   
							...
							<div class="cast_touroku_area">
								...
								<p>
									<label>
										<span>Instagram</span><span style="font-size: 80%; color: #000000;"><?php echo $profinfo9; ?></span><br />
										<span style="font-size: 80%; color: #FF0000;">※変更する場合はID（ユーザー名）を担当者又は運営部までご連絡ください。</span>
									</label>
								</p>
								<p>
									<label>
										<span>You Tube</span><span style="font-size: 80%; color: #000000;"><?php echo $option3; ?></span><br />
										<span style="font-size: 80%; color: #FF0000;">※変更する場合はYou TubeチャンネルURLを担当者又は運営部までご連絡ください。</span>
									</label>									
								</p>
								<p>
									<label>
										<span>Twitter</span><span style="font-size: 80%; color: #000000;"><?php echo $profinfo10; ?></span><br />
										<span style="font-size: 80%; color: #FF0000;">※変更する場合はID（ユーザー名）を担当者又は運営部までご連絡ください。</span>
									</label>									
								</p>
								<p>
									<label>
										<span>Tik Tok</span><span style="font-size: 80%; color: #000000;"><?php echo $option5; ?></span><br />
