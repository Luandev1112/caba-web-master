...
<body>
	<div id="top_fade">
		<div class="drawer drawer--left">
			...
			<div class="header_space">
				<div class="wrapper">
					...
					<div class="element_sp_2 header_space_img">
						<h1><a href="login_top.php?master_id=<?php echo $master_id; ?>" title=""><img src="img/logo.svg" alt=""></a></h1>
					</div>
			...
			<header role="banner">
				...
				<nav class="drawer-nav" role="navigation">
					<ul class="drawer-menu">
						<li class="drawer-brand_first"><a class="drawer-brand" href="login_top.php?master_id=<?php echo $master_id; ?>" title="ホーム">ホーム</a></li>
		  ...
		  ?>	
						<!--li><a class="drawer-brand" href="contact.php?master_id=<?php echo $master_id; ?>" title="お問合せ・更新依頼">お問合せ・更新依頼</a></li-->
						<li><a class="drawer-brand" href="<?php echo $s_url; ?>" target="_blank" title="ホームページ確認">ホームページ確認</a></li>
						<li><a class="drawer-brand" href="logout.php?master_id=<?php echo $master_id; ?>" title="ログアウト">ログアウト</a></li>
					</ul>
				</nav>
			</header>
		  ...
		  if($portal == '1'){
			  echo "<div class=\"top_portal_box\">
						...
						<div class=\"button_area_1\">
							<a href=\"portal.php?master_id=".$master_id."\" class=\"btn_portal\">ナイトグラム<br />注意事項</a>
						</div>
					</div>";
		  }else{
			  echo "";
...
while($row=mysqli_fetch_assoc($result)){
include('../cabaweb_master_admin/parts/basic_hensu9.php');
...
echo "<div class=\"element_news\"><div class=\"top_news_box\"><div class=\"photo_thumbs\">\n";
	...
	if($photo1 == $empty){
	echo "<img src=\"\" data-src=\"../cabaweb_master_admin/photo/nophoto_1.jpg\" class=\"lozad\" alt=\"\">\n";
}else{
	if($photo_box == '1'){
...
?>
	...
	<div class="page_base_box_2">
      <div class="button_area_2"><a href="schedule.php?master_id=<?php echo $master_id; ?>" class="btn_main">本日の出勤設定</a></div>		
...
echo "<div class=\"element_cast\"><div class=\"top_cast_box\"><div class=\"top_cast_box_in\"><div class=\"photo_thumbs\">\n";
	...
	if($photo1 == $empty){
	echo "<img src=\"\" data-src=\"../cabaweb_master_admin/photo/nophoto_1.jpg\" class=\"lozad\" alt=\"".$name."\">\n";
}else{
...
while($row=mysqli_fetch_assoc($result)){
include('../cabaweb_master_admin/parts/basic_hensu7.php');
}
		$count = 0;
		$tcol = 1;
