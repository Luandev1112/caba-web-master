...
//		array_splice($data , $i , 1 , $line);
		mysqli_query($sql, "UPDATE `data4` SET `id`='$id',`name`='$name',`name2`='$name2',`link1`='$link1',`link2`='$link2',`link3`='$link3',`link4`='$link4',`link5`='$link5',`link6`='$link6',`link7`='$link7',`link8`='$link8',`link9`='$link9',`link10`='$link10',`end1`='$end1',`end2`='$end2',`end3`='$end3',`end4`='$end4',`end5`='$end5',`end6`='$end6',`end7`='$end7',`end8`='$end8',`end9`='$end9',`end10`='$end10',`edittime`='$edittime' WHERE `name2` LIKE '$name2' LIMIT 1");
	} elseif ($operation == 'delete') {
//		array_splice($data , $i , 1);
		mysqli_query($sql, "DELETE FROM `data4` WHERE name2 LIKE '$name2' LIMIT 1");
	}
...
$data = mysqli_query($sql, "SELECT * FROM `data4` WHERE name2 LIKE '$name2'");
...
mysqli_query($sql, "UPDATE `data4` SET `photo1`='$photo1', `photo2`='$photo2', `photo3`='$photo3', `photo4`='$photo4', `photo5`='$photo5', `photo6`='$photo6', `photo7`='$photo7', `photo8`='$photo8', `photo9`='$photo9', `photo10`='$photo10' WHERE `name2` LIKE '$name2' LIMIT 1");


//写真を削除
if($delete1=='delete'){
	unlink('../client_admin/photo/'.$name2.'_1r.jpg');
	unlink('../client_admin/photo/'.$name2.'_1_mr.jpg');
	
	echo "<p>".$name."スライダー画像1枚目を削除しました。</p>\n";
}
if($delete2=='delete'){
	unlink('../client_admin/photo/'.$name2.'_2r.jpg');
	unlink('../client_admin/photo/'.$name2.'_2_mr.jpg');
		
	echo "<p>".$name."スライダー画像2枚目を削除しました。</p>\n";
}
if($delete3=='delete'){
	unlink('../client_admin/photo/'.$name2.'_3r.jpg');
	unlink('../client_admin/photo/'.$name2.'_3_mr.jpg');
		
	echo "<p>".$name."スライダー画像3枚目を削除しました。</p>\n";
}
if($delete4=='delete'){
	unlink('../client_admin/photo/'.$name2.'_4r.jpg');
	unlink('../client_admin/photo/'.$name2.'_4_mr.jpg');
		
	echo "<p>".$name."スライダー画像4枚目を削除しました。</p>\n";
}
if($delete5=='delete'){
	unlink('../client_admin/photo/'.$name2.'_5r.jpg');
	unlink('../client_admin/photo/'.$name2.'_5_mr.jpg');
		
	echo "<p>".$name."スライダー画像5枚目を削除しました。</p>\n";
}
if($delete6=='delete'){
	unlink('../client_admin/photo/'.$name2.'_6r.jpg');
	unlink('../client_admin/photo/'.$name2.'_6_mr.jpg');

	echo "<p>".$name."スライダー画像6枚目を削除しました。</p>\n";
}
if($delete7=='delete'){
	unlink('../client_admin/photo/'.$name2.'_7r.jpg');
	unlink('../client_admin/photo/'.$name2.'_7_mr.jpg');

	echo "<p>".$name."スライダー画像7枚目を削除しました。</p>\n";
}
if($delete8=='delete'){
	unlink('../client_admin/photo/'.$name2.'_8r.jpg');
	unlink('../client_admin/photo/'.$name2.'_8_mr.jpg');

	echo "<p>".$name."スライダー画像8枚目を削除しました。</p>\n";
}
if($delete9=='delete'){
	unlink('../client_admin/photo/'.$name2.'_9r.jpg');
	unlink('../client_admin/photo/'.$name2.'_9_mr.jpg');

	echo "<p>".$name."スライダー画像9枚目を削除しました。</p>\n";
}
if($delete10=='delete'){
	unlink('../client_admin/photo/'.$name2.'_10r.jpg');
	unlink('../client_admin/photo/'.$name2.'_10_mr.jpg');
