...
if (($photo_type1 == 'image/jpeg') || ($photo_type1 == 'image/pjpeg') || ($photo_type1 == 'image/gif') || ($photo_type1 == 'image/png')) {
  ...
  $image = imagecreatefromjpeg($temp_name1);

  $image_size = getimagesize($temp_name1);
  ...
  $result_m = imagecopyresampled($image_m , $image , 0,0, $profileImageX_1,$profileImageY_1, 600 , 600 , $profileImageW_1, $profileImageH_1);

  imagejpeg($image_m , $temp_name1 , $quality);
...
//fclose($handle);
mysqli_query($sql3, "UPDATE `data` SET `option11`='$option11',`option13`='$option13',`photo1`='$photo1', `photo2`='$photo2', `photo3`='$photo3', `photo4`='$photo4', `photo5`='$photo5', `photo6`='$photo6', `photo7`='$photo7', `photo8`='$photo8', `photo9`='$photo9', `photo10`='$photo10' WHERE `name2` LIKE '$name2' LIMIT 1");
