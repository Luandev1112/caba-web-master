...
$result=mysqli_query($sql, "SELECT * From `taiken` WHERE `shop_no` = '$login_id'");
while($row=mysqli_fetch_assoc($result)){
...
<option value="0"<?php echo $num0; ?>>--</option>
	  ...
	  <input type="hidden" name="shop_no" value="<?php echo $shop_no; ?>" /><input type="hidden" name="master_id" value="<?php echo $master_id; ?>" />
