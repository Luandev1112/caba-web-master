		...
		<div id="page_base">
			...
			<div class="page_base_in">
				<div class="page_base_box">
					<h3>新しいキャストを登録</h3>
					<div class="button_area_2"><a href="cast_new.php?master_id=<?php echo $master_id; ?>" class="btn_main">新規キャスト登録</a></div>
				</div>
...
include('../cabaweb_master_admin/parts/starttime_conversion2.php');	/* 出勤開始時間を変換 */
