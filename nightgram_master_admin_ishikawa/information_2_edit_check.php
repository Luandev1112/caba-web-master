...
<html lang="ja"><head>
<meta charset="utf-8">
<title>運営からのお知らせ確認｜Admin Tool</title>
<meta name="description" content="管理画面ツール　運営からのお知らせ確認">
					...
					<div class="page_base_box_2">
						...
						<form action="hotnews_check.php" method="post" id="form" enctype="multipart/form-data">
							<p>
								<label>
									<span>■掲載エリア</span><br />
									<span style="font-size: 80%; color: #4D4D4D;">エリア名</span>
								</label>
							</p>
							<p>
								<label>
									<span>■街名</span><br />
									<span style="font-size: 80%; color: #4D4D4D;">街名</span>
								</label>
							</p>
							<p>
								<label>
									<span>■店舗名</span><br />
									<span style="font-size: 80%; color: #4D4D4D;">店舗名</span>
								</label>
							</p>							
							<p>
								<label>
