...
mysqli_query($sql2, "UPDATE `data` SET `yotei1`='$yotei1',`start1`='$start1',`end1`='$end1',`yotei2`='$yotei2',`start2`='$start2',`end2`='$end2',`yotei3`='$yotei3',`start3`='$start3',`end3`='$end3',`yotei4`='$yotei4',`start4`='$start4',`end4`='$end4',`yotei5`='$yotei5',`start5`='$start5',`end5`='$end5',`yotei6`='$yotei6',`start6`='$start6',`end6`='$end6',`yobi4`='$yobi4',`yobi5`='$yobi5',`yobi6`='$yobi6',`yobi9`='$yobi9' WHERE `name2` LIKE '$name2' LIMIT 1");
...
<body>
	...
	<div class="drawer drawer--left">
		...
		<div id="page_base">
			<h2><?php echo $s_name; ?><br /><span style="font-size: 70%;">当日出勤設定</span></h2>
			<div class="page_base_in">
				<div class="page_base_box">
					<h3>体験入店者数の設定</h3>
					<div class="button_area_2"><a href="taiken.php?no=<?php echo $no; ?>" class="btn_main">体験人数を設定する</a></div>
				</div>
				<div class="page_base_box_2">				
					...
					<form action="schedule.php?no=<?php echo $no; ?>" method="post"><input type="hidden" name="mode" value="write">
						<div class="wrapper">
							<?php
