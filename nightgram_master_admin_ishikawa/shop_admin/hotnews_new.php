...
<html lang="ja"><head>
<meta charset="utf-8">
<title>新規ニュース登録｜Admin Tool</title>
...
<body>
	<div id="top_fade">
		<div class="drawer drawer--left">
			...
			<div id="page_base">
				<h2><?php echo $s_name; ?><br /><span style="font-size: 70%;">新規ニュース登録</span></h2>
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<form action="hotnews_check.php" method="post" id="form" enctype="multipart/form-data">
							...
							<p>
								<label>
									<span>掲載終了日</span><input type="date" name="start" id="today" min="2020-04-20" required><br />
							...
							<p>
								<label>
									<span>リンクURL設定</span>
									<input type="url" name="n_link" class="txtfiled" placeholder="例）https://www.nightgram.com/"><br />
							...
							<input type="hidden" name="blank" value="<?php echo $data5; ?>" />
