...
$result=mysqli_query($sql2, "SELECT * From `news`");
mysqli_query($sql2, "INSERT INTO `news` VALUES ('$news_id','$start','$sort','$end','$sort2','$time','$newstitle','$input','$photo1','$jpeg','$link','$blank','$hotnews','$photo_box','$n_area','$n_area2','$n_gyoushu','$n_link','$news_no','$sort_order')");
