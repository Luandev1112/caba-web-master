										...
										<p>
											<label><span>街名で選択</span>
												<select name="search2">
													<option value="">--</option>
													<?php
$result=mysqli_query($sql, "SELECT * From `toshi_tb` WHERE  toshi_area='7' ");
...
?>
						...
						<div class="wrapper">
							<?php
$result=mysqli_query($sql, "SELECT * From `information` WHERE info_select!='1' AND info_naiyou='7' ".$search2_sql." ".$search3_sql." ORDER by info_id DESC");
$cnt=mysqli_num_rows($result);
