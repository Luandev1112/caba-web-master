...
<html lang="ja"><head>
<meta charset="utf-8">
<title>スタッフ求人スライダー画像設定｜CLIENT Admin Tool</title>
<meta name="description" content="管理画面ツール　スタッフ求人スライダー画像設定">
...
if (($photo_type1 == 'image/jpeg') || ($photo_type1 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		//アップロードの成功
		echo '<a class="media-left media-top" href="' . $upload_name1 . '" target="_blank"><img src="' . $upload_name1. '?' . $koshin . '" alt="photo1"  width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像1枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name1_m , $quality)) {
				echo '<p>スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type2 == 'image/jpeg') || ($photo_type2 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name2 . '" target="_blank"><img src="' . $upload_name2. '?' . $koshin . '" alt="photo2"  width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像2枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name2_m , $quality)) {
				echo '<p>2枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>2枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>2枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type3 == 'image/jpeg') || ($photo_type3 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name3 . '" target="_blank"><img src="' . $upload_name3. '?' . $koshin . '" alt="photo3" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像3枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name3_m , $quality)) {
				echo '<p>3枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>3枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>3枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type4 == 'image/jpeg') || ($photo_type4 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name4 . '" target="_blank"><img src="' . $upload_name4. '?' . $koshin . '" alt="photo4" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像4枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name4_m , $quality)) {
				echo '<p>4枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>4枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>4枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type5 == 'image/jpeg') || ($photo_type5 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name5 . '" target="_blank"><img src="' . $upload_name5. '?' . $koshin . '" alt="photo5" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像5枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name5_m , $quality)) {
				echo '<p>5枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>5枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>5枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type6 == 'image/jpeg') || ($photo_type6 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name6 . '" target="_blank"><img src="' . $upload_name6. '?' . $koshin . '" alt="photo6" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像6枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name6_m , $quality)) {
				echo '<p>6枚目スタッフ求人スライダー画像保存(_m)</p>';
			} else {
				echo '<p>6枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>6枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type7 == 'image/jpeg') || ($photo_type7 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name7 . '" target="_blank"><img src="' . $upload_name7. '?' . $koshin . '" alt="photo7" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像7枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name7_m , $quality)) {
				echo '<p>7枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>7枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>7枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type8 == 'image/jpeg') || ($photo_type8 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name8 . '" target="_blank"><img src="' . $upload_name8. '?' . $koshin . '" alt="photo8" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像8枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name8_m , $quality)) {
				echo '<p>8枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>8枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>8枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type9 == 'image/jpeg') || ($photo_type9 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name9 . '" target="_blank"><img src="' . $upload_name9. '?' . $koshin . '" alt="photo4" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像9枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name9_m , $quality)) {
				echo '<p>9枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>9枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>9枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if (($photo_type10 == 'image/jpeg') || ($photo_type10 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name10 . '" target="_blank"><img src="' . $upload_name10. '?' . $koshin . '" alt="photo10" width="20%" /></a><div class="media-body"><h4 class="media-heading">スタッフ求人スライダー画像10枚目</h4>';
		...
		if ($result_m) {
			...
			if (imagejpeg($image_m , $upload_name10_m , $quality)) {
				echo '<p>10枚目スタッフ求人スライダー画像保存</p>';
			} else {
				echo '<p>10枚目スタッフ求人スライダー画像保存失敗</p>';
			}
		} else {
			echo '<p>10枚目スタッフ求人スライダー画像作成失敗</p>';
		}
...
if ($photo_name1 != $empty) {$photo1 = $dir . $name2 . '_1j';}
if ($photo_name2 != $empty) {$photo2 = $dir . $name2 . '_2j';}
if ($photo_name3 != $empty) {$photo3 = $dir . $name2 . '_3j';}
if ($photo_name4 != $empty) {$photo4 = $dir . $name2 . '_4j';}
if ($photo_name5 != $empty) {$photo5 = $dir . $name2 . '_5j';}
if ($photo_name6 != $empty) {$photo6 = $dir . $name2 . '_6j';}
if ($photo_name7 != $empty) {$photo7 = $dir . $name2 . '_7j';}
if ($photo_name8 != $empty) {$photo8 = $dir . $name2 . '_8j';}
if ($photo_name9 != $empty) {$photo9 = $dir . $name2 . '_9j';}
if ($photo_name10 != $empty) {$photo10 = $dir . $name2 . '_10j';}
...
//写真を削除
if($delete1=='delete'){
	unlink('./photo/'.$name2.'_1j.jpg');
	unlink('./photo/'.$name2.'_1_mj.jpg');
	
	echo "<p>".$name."スタッフ求人スライダー画像1枚目を削除しました。</p>\n";
}
if($delete2=='delete'){
	unlink('./photo/'.$name2.'_2j.jpg');
	unlink('./photo/'.$name2.'_2_mj.jpg');
		
	echo "<p>".$name."スタッフ求人スライダー画像2枚目を削除しました。</p>\n";
}
if($delete3=='delete'){
	unlink('./photo/'.$name2.'_3j.jpg');
	unlink('./photo/'.$name2.'_3_mj.jpg');
		
	echo "<p>".$name."スタッフ求人スライダー画像3枚目を削除しました。</p>\n";
}
if($delete4=='delete'){
	unlink('./photo/'.$name2.'_4j.jpg');
	unlink('./photo/'.$name2.'_4_mj.jpg');
		
	echo "<p>".$name."スタッフ求人スライダー画像4枚目を削除しました。</p>\n";
}
if($delete5=='delete'){
	unlink('./photo/'.$name2.'_5j.jpg');
	unlink('./photo/'.$name2.'_5_mj.jpg');
		
	echo "<p>".$name."スタッフ求人スライダー画像5枚目を削除しました。</p>\n";
}
if($delete6=='delete'){
	unlink('./photo/'.$name2.'_6j.jpg');
	unlink('./photo/'.$name2.'_6_mj.jpg');

	echo "<p>".$name."スタッフ求人スライダー画像6枚目を削除しました。</p>\n";
}
if($delete7=='delete'){
	unlink('./photo/'.$name2.'_7j.jpg');
	unlink('./photo/'.$name2.'_7_mj.jpg');

	echo "<p>".$name."スタッフ求人スライダー画像7枚目を削除しました。</p>\n";
}
if($delete8=='delete'){
	unlink('./photo/'.$name2.'_8j.jpg');
	unlink('./photo/'.$name2.'_8_mj.jpg');

	echo "<p>".$name."スタッフ求人スライダー画像8枚目を削除しました。</p>\n";
}
if($delete9=='delete'){
	unlink('./photo/'.$name2.'_9j.jpg');
	unlink('./photo/'.$name2.'_9_mj.jpg');

	echo "<p>".$name."スタッフ求人ライダー画像9枚目を削除しました。</p>\n";
}
if($delete10=='delete'){
	unlink('./photo/'.$name2.'_10j.jpg');
	unlink('./photo/'.$name2.'_10_mj.jpg');

	echo "<p>".$name."スタッフ求人スライダー画像10枚目を削除しました。</p>\n";
}
?>
</div><!--base-->
