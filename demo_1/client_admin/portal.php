  ...
  <div class="page_base_box_2">
    <div class="portal_page_base">
      ...
      <div class="portal_box">
        ...
        <div class="portal_box_naiyou">
        Instagramの登録にはID（ユーザー名）とパスワードが必要になります。<br />
        その際にナイトグラムと連携させるために運営にてログインさせて頂きますのでご了承下さい。<br />
      ...
      <div class="portal_box">
        ...
        <br />
        <span style="color: #000; font-size: 110%;">①ID（ユーザー名）とパスワードの確認</span><br />
        ログインの有無を必ず確認して下さい。<br />
        パスワードを忘れた場合はSafariやGoogle Chromeなどのブラウザにて再発行して下さい。<br />
        アプリだと自動ログインして出来ません。<br />
        <br />
        ...
        <br />
        <span style="color: #000; font-size: 110%;">③二段階認証の解除</span><br />
        必ず二段階認証を解除して下さい。<br />
        Instagramアプリのセキュリティから解除できます。<br />
        <br />
        以上、3点をクリアしないと連携できません。<br />
        <br />
        <span style="color:#F33">
        ※InstagramアカウントのID（ユーザー名）とパスワードを変更すると連携が解除される場合がありますので、必ず変更時に新しいID（ユーザー名）とパスワードを担当者にご連絡下さい。</span><br />
        </div>
      </div>
      ...
      <div class="portal_box">
        ...
        Instagramを非公開設定にしても掲載されますのでご注意下さい。<br />
        <br />
        <span style="color: #000; font-size: 110%;">②ID（ユーザー名）を変更した場合</span><br />
        ID（ユーザー名）を変更してもナイトグラムには反映されます。<br />
        しかし、プロフィールページのInstagramアイコンのリンクには反映されないため、ID（ユーザー名）を変更した場合は必ず担当までご連絡下さい。<br />
        <br />
        <span style="color: #000; font-size: 110%;">③パスワードを変更した場合</span><br />
        パスワードを変更するとナイトグラムには反映されません。<br />
        そのため、パスワードを変更した場合は必ず担当までご連絡下さい。<br />
        <br />
        <span style="color:#F33">
        ※InstagramアカウントのID（ユーザー名）とパスワードを変更すると連携が解除される場合がありますので、必ず変更時に新しいID（ユーザー名）とパスワードを担当者にご連絡下さい。</span><br />
        </div>
      ...
      <div class="portal_box">
        ...
        <div class="portal_box_naiyou">
        Instagramで投稿した記事はナイトグラムに反映するまで最大10分前後の時間差が生じます。<br />
        </div>       
      </div>      
