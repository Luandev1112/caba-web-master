...
<html lang="ja"><head>
<meta charset="utf-8">
<title>ホットニュース編集｜CLIENT Admin Tool</title>
...
<div class="page_base_in">
  ...
  <div class="page_base_box_2">
    ...
    <form action="hotnews_rewrite.php" method="post" id="form">
...
<input type="hidden" name="end" value="<?php echo $end; ?>" />
    ...
    <p>
    <label><span>タイトル（<font color="#CC0000">必須</font>）</span><input type="text" name="newstitle" class="txtfiled" placeholder="例）あいちゃんバースデーイベント開催！" value="<?php echo $newstitle; ?>" required><br />
    <span style="font-size:60%; color:#FF6666;">※絵文字を使用した場合、絵文字が削除されてしまう場合がございます。</span></label>
    </p>   
    <p>
    <label><span>掲載終了日（<font color="#CC0000">必須</font>）</span><input type="date" name="start" id="today" value="<?php echo $start; ?>"  required><br />
    <span style="font-size:60%; color:#FF6666;">設定した日付を過ぎると自動的に削除されます。</span>
    </label>
    </p>
    <p>
    <label><span>内容（<font color="#CC0000">必須</font>）</span><?php $input = str_replace("<br />" , "\r\n" , $input); ?><textarea name="input" class="txtfiled" rows="5"><?php echo $input; ?></textarea><br />
    <span style="font-size:60%; color:#FF6666;">※絵文字を使用した場合、絵文字が削除されてしまう場合がございます。</span></label>
    </p>  
