...
<html lang="ja"><head>
<meta charset="utf-8">
<title>キャスト編集｜CLIENT Admin Tool</title>
...
<input type="hidden" name="yobi1" value="<?php echo $yobi1; ?>" />
    <p>
    <label><span>お名前（<font color="#CC0000">必須</font>）</span><input type="text" name="name" class="txtfiled" placeholder="例）優子" value="<?php echo $name; ?>" required></label>
    </p>
    <p>
    <label><span>年齢</span>
    <select name="age">
...
?>
    ...
    <p>
    <label><span>ひとこと</span><?php $comment = str_replace("<br />" , "\r\n" , $comment); ?><textarea name="comment" class="txtfiled" rows="5"><?php echo $comment; ?></textarea></label>
    </p>

  <div class="castnew_blog_area">
    <h3>SNS登録</h3>
    <p>
    <label><span>Instagram URL</span><input type="text" name="profinfo9" class="txtfiled" placeholder="例）https://www.instagram.com/" value="<?php echo $profinfo9; ?>"></label>
    </p>
    <p>
    <label><span>Twitter URL</span><input type="text" name="profinfo10" class="txtfiled" placeholder="例）https://twitter.com/" value="<?php echo $profinfo10; ?>"></label>
    </p>
    <p>
    <label><span>Amebloなどのブログ URL</span><input type="url" name="profinfo11" class="txtfiled" placeholder="例）https://ameblo.jp/" value="<?php echo $profinfo11; ?>"></label>
    </p>        
  </div> 
  ...
  <div class="castnew_blog_area">
    ...
    <h3>Instagram 詳細</h3>
    <p>
    <label><span>Instagram rss url</span><?php echo $option2; ?></label>
    </p>
	   <p>
    <label><span>Instagram Tag</span><textarea name="comment2" class="txtfiled" placeholder="" rows="3"><?php echo $comment2; ?></textarea></label>
    </p> 
        
  </div><input type="hidden" name="profinfo12" value="<?php echo $profinfo12; ?>" /><input type="hidden" name="profinfo13" value="<?php echo $profinfo13; ?>" /><input type="hidden" name="profinfo14" value="<?php echo $profinfo14; ?>" /><input type="hidden" name="option2" value="<?php echo $option2; ?>" />
