...
$result=mysqli_query($sql, "SELECT * From `data5` WHERE `name2` = '$group_id'");
while($row=mysqli_fetch_assoc($result)){
...
<html lang="ja"><head>
<meta charset="utf-8">
<title>グループページスライダー画像設定｜CLIENT Admin Tool</title>
<meta name="description" content="管理画面ツール　グループページスライダー画像設定">
...
?>】</span><br />
    ...
    <form action="slider_group_write.php" method="post" id="form_3" enctype="multipart/form-data">
