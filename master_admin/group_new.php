...
<div class="page_base_in">
  ...
  <div class="page_base_box_2">
    ...
    <label><span>グループ名（<font color="#CC0000">必須</font>）</span>
      <input type="text" name="name" class="txtfiled" placeholder="例)〇〇グループ" required></label>
    </p>
    <p>
    <label><span>グループID（<font color="#CC0000">必須</font>）</span><input type="text" name="name2" pattern="^[0-9A-Za-z]+$" class="txtfiled" placeholder="グループID入力" required></label>
    </p>
