...
<html lang="ja"><head>
<meta charset="utf-8">
<title>キャスト編集｜キャスト管理</title>
<meta name="description" content="キャスト管理ツール　キャスト編集">
...
<div class="page_base_in">
  ...
  <div class="page_base_box_2">
    ...
    <p>
    <label><span>ひとこと</span><textarea name="ひとこと" class="txtfiled" rows="5"></textarea></label>
    </p> 

  <div class="castnew_blog_area_2">
    <h3>SNS登録</h3>
    <p>
