...
<html lang="ja"><head>
<meta charset="utf-8">
<title>キャバクラ「きゃばWEB」3</title>
<meta name="description" content="キャバクラ「きゃばWEB」3の公式ホームページです。">
		...
		<div class="drawer drawer--top">
			...
			<div class="top_news_bg">
				<div class="top_contents_in">
					<h2>NEWS<br /><span class="h_sub">最新ニュース</span></h2>
					<div class="wrapper">
						<div class="element_news">
							<a href="hotnews.php#1">
								<div class="top_hotnews_a">
									<div class="top_hotnews_b">
										<div class="trimming"><img src="img/top1.jpg" alt=""></div>
									</div>
									<div class="top_hotnews_c">             
										<h3>ホームページ開設しました！</h3>
										<div class="top_hotnews_border"></div>
										<div class="top_hotnews_naiyou">オフィシャルサイトがオープンしました！<br />最新情報を更新していきます!<br /><br />お気に入り登録お願いします！</div>
									</div>
									<div class="clear"></div>
								</div>
							</a>        
						...
						<div class="element_news">
							<a href="hotnews.php#2">
								<div class="top_hotnews_a">
									<div class="top_hotnews_b">
										<div class="trimming"><img src="img/top2.jpg" alt=""></div>
									</div>
									<div class="top_hotnews_c">             
										<h3>グランドオープン！</h3>
										<div class="top_hotnews_border"></div>
										<div class="top_hotnews_naiyou">駅前にガールズバーが今月オープン！<br />是非、ご来店下さい！</div>
									</div>
									<div class="clear"></div>
								</div>
							</a>
						...
						<div class="element_news">
							<a href="hotnews.php#3">
								<div class="top_hotnews_a">
									<div class="top_hotnews_b">
										<div class="trimming"><img src="img/top3.jpg" alt=""></div>
									</div>
									<div class="top_hotnews_c">             
										<h3>オープニングキャスト大募集中です！</h3>
										<div class="top_hotnews_border"></div>
										<div class="top_hotnews_naiyou">オープニングキャスト大募集中です！<br />みんなゼロからのスタート！<br /><br />未経験者大歓迎です！！</div>
									</div>
									<div class="clear"></div>
								</div>
							</a>
						...
						<div class="element_news">
							<a href="hotnews.php#4">
								<div class="top_hotnews_a">
									<div class="top_hotnews_b">
										<div class="trimming"><img src="img/top5.jpg" alt=""></div>
									</div>
									<div class="top_hotnews_c">             
										<h3>働くママも安心して働けます！</h3>
										<div class="top_hotnews_border"></div>
										<div class="top_hotnews_naiyou">当店はママでも安心して働ける環境が整ってます！<br />託児所も完備!!<br /><br />是非、お気軽にお問い合わせ下さい。</div>
									</div>
									<div class="clear"></div>
								</div>
							</a>
			...
			<div class="top_schedule_bg">
				<div class="top_contents_in">
					<h2>TODAYs CAST<br /><span class="h_sub">本日のキャスト出勤情報</span></h2>
					<div class="wrapper_slide">
						<div class="element_cast">
							<div class="top_schedule_box">
								<a href="prof.php" title="">
									<div class="top_schedule_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/cast-1.jpg" class="lozad" alt=""></div>
						...
						<div class="element_cast">
							<div class="top_schedule_box">
								<a href="prof.php" title="">
									<div class="top_schedule_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/cast-2.jpg" class="lozad" alt=""></div>
										<div class="fa_insta"><img src="" data-src="img/cast_instagram.svg" class="lozad"></div>
										<p>みか</p>
									</div>
								</a>
						...
						<div class="element_cast">
							<div class="top_schedule_box">
								<a href="prof.php" title="">
									<div class="top_schedule_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/cast-3.jpg" class="lozad" alt=""></div>
										<p>あい</p>
									</div>
								</a>
							</div>
						...
						<div class="element_cast">
							<div class="top_schedule_box">
								<a href="prof.php" title="">
									<div class="top_schedule_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/nophoto.jpg" class="lozad" alt=""></div>
										<div class="fa_insta"><img src="" data-src="img/cast_instagram.svg" class="lozad"></div>
										<p>ゆりあ</p>
									</div>
								</a>
			...
			<div class="top_instagram_bg">
				<div class="top_contents_in">
				<h2>INSTAGRAM<br /><span class="h_sub">インスタグラム</span></h2>
					<div id="list">
						<div class="li">
							<a href="" title="">
								<div class="top_instagram_list_box">
									<div class="top_instagram_list_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/insta-1.jpg" class="lozad" alt="" ></div>
									</div>
									<div class="top_instagram_list_box_name">ゆりあ</div>
								</div>
							</a>
						</div>
						<div class="li">
							<a href="" title="">
								<div class="top_instagram_list_box">
									<div class="top_instagram_list_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/insta-2.jpg" class="lozad" alt="" ></div>
									</div>
									<div class="top_instagram_list_box_name">ゆりあ</div>
								</div>
							</a>
						...
						<div class="li">
							<a href="" title="">
								<div class="top_instagram_list_box">
									<div class="top_instagram_list_box_in">
										<div class="photo_thumbs"><img src="" data-src="img/insta-3.jpg" class="lozad" alt="" ></div>
										<div class="fa"><img src="" data-src="img/play.svg" class="lozad"></div>
									</div>
									<div class="top_instagram_list_box_name">ゆりあ</div>
								</div>
							</a>
			...
			<div class="top_youtube_bg">
				<div class="top_contents_in">
					<h2>You Tube<br /><span class="h_sub">ユーチューブ</span></h2>
					<div id="list_2">
						<div class="li">
							<a href="" id="modal-open" title="">
								<div class="top_youtube_list_box">
									<div class="top_youtube_list_box_in">
										<div class="youtube_thumbs"><img src="" data-src="img/youtube-1.jpg" class="lozad"></div>
										<div class="fa_2"><img src="" data-src="img/play_2.svg" class="lozad"></div>
									</div>
									<div class="top_youtube_list_box_name">ゆりか</div>
								</div>
							</a>
						</div>
						<div class="li">
							<a href="" id="modal-open" title="">
								<div class="top_youtube_list_box">
									<div class="top_youtube_list_box_in">
										<div class="youtube_thumbs"><img src="" data-src="img/youtube-2.jpg" class="lozad"></div>
										<div class="fa_2"><img src="" data-src="img/play_2.svg" class="lozad"></div>
									</div>
									<div class="top_youtube_list_box_name">ゆりか</div>
								</div>
			...
			<div class="top_shopphoto_bg">
				<div class="top_contents_in">
					<h2>SHOP PHOTO<br /><span class="h_sub">店内写真</span></h2>
					<div class="wrapper">
				...
				<div class="top_contents_in">					
					<div class="wrapper">
						<div class="element_footer">
							<div class="footer_info_box">
								<div class="footer_info_box_main">
									<div class="footer_info_box_a"><img src="" data-src="img/tel_footer.svg" class="lozad"></div>
									<div class="footer_info_box_b"><div class="footer_info_box_b_title">CALL US</div><a href="tel:080-7798-4702">080-7798-4702</a></div>
									<div class="clear"></div>
								</div>
							</div>
						</div>
						<div class="element_footer">
							<div class="footer_info_box">
								<div class="footer_info_box_main">
									<div class="footer_info_box_a"><img src="" data-src="img/map_footer.svg" class="lozad"></div>
									<div class="footer_info_box_b"><div class="footer_info_box_b_title">ADDRESS</div>群馬県前橋市天川大島町</div>
									<div class="clear"></div>
								</div>
							</div>
						</div>
						<div class="element_footer">
							<div class="footer_info_box">
								<div class="footer_info_box_main">
									<div class="footer_info_box_a"><img src="" data-src="img/info_footer.svg" class="lozad"></div>
									<div class="footer_info_box_b"><div class="footer_info_box_b_title">SHOP INFO</div>OPEN. 19:30-LAST / CLOSED. 日曜日</div>
									<div class="clear"></div>
								</div>
							</div>
						</div>					
			...
			<div id="footer_2">
				<div class="top_contents_in">					
					<ul class="inline-block footer_img_1">
						<li><a href="https://www.facebook.com/" target="_blank" title="Facebook"><img src="" data-src="img/facebook_2.svg" class="lozad" alt="Facebook" /></a></li>
						<li><a href="https://www.instagram.com/" target="_blank" title="Instagram"><img src="" data-src="img/instagram_2.svg" class="lozad" alt="Instagram" /></a></li>
						<li><a href="https://twitter.com/" target="_blank" title="Twitter"><img src="" data-src="img/twitter_2.svg" class="lozad" alt="Twitter" /></a></li> 
						<li><a href="https://official.ameba.jp/" target="_blank" title="ブログ"><img src="" data-src="img/blog_2.svg" class="lozad" alt="ブログ" /></a></li>
						<li><a href="https://www.youtube.com/" target="_blank" title="You Tube"><img src="" data-src="img/youtube_2.svg" class="lozad" alt="You Tube" /></a></li>
					</ul>				
				</div>
				<p>© 2020 CABAWEB.</p>				
			</div>
