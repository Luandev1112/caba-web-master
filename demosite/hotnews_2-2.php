    ...
    <div class="shop_page_hotnews_a">
      <div class="shop_page_hotnews_b">
        <div class="my-gallery_2">
          <figure>
          <a href="img/ai-1.jpg" data-size="600x900" title="">
          <div class="trimming_news"><img src="img/ai-1.jpg"></div>
          </a>
          </figure>
        </div>
      </div><!--shop_page_hotnews_b-->
      <div class="shop_page_hotnews_c">
        <div class="shop_page_hotnews_ymd">2018.10.15 / 20:20</div>
        <div class="shop_page_hotnews_title">あいちゃん誕生日イベント開催</div>
        <div class="shop_page_hotnews_naiyou">
        あいちゃんの誕生日イベントを開催します！開催日は11月11日です。<br />
        <br />
        当店であいちゃんのお誕生日をお祝いしよう！<br />
        </div>
