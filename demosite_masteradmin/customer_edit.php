...
<div class="page_base_in">
  ...
  <div class="page_base_box_2">
    ...
    <p>
    <label><span>Web最終更新日（<font color="#CC0000">必須</font>）</span><input type="date" name="today" id="today" required><br />
    </label>
    </p>
    <p>
    <label><span>今月のトップ画像更新（<font color="#CC0000">必須</font>）</span>
    <select name="今月のトップ画像更新" required>
    ...
    <select name="今月の求人画像更新" required>
    <option value="未更新">未更新</option>
    <option value="更新済">更新済</option>       
    </select>
    </label>
