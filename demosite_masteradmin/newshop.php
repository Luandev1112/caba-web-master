...
<html lang="ja"><head>
<meta charset="utf-8">
<title>新規掲載店設定｜Admin Tool</title>
<meta name="description" content="管理画面ツール　新規掲載店設定">
...
<div class="page_base_in">
  ...
  <h3>掲載店登録</h3>
    <div class="todayscast_button"><a href="newshop_new.php" class="btn_2">新規掲載店登録</a></div>  
  </div>  
    ...
    <div class="element_2">
        <div class="hotnews_page_box_a">
          ...
          <div class="hotnews_page_box_c">
            <div class="top_hotnews_category">富山 / キャバクラ</div>
            <div class="top_hotnews_shop">AZITO</div>              
            <div class="top_hotnews_title">新規掲載しました。</div>
            <div class="top_hotnews_ymd">2018.10.10</div>
            
              <div class="top_cast_box_button_a">
                <a href="newshop_edit.php" class="btn_1">編集</a>
              ...
              <div id="modal_delete_1" class="modal_box">          
                <p>
                  <div class="castschedule_modal_box_title">新規掲載店を削除</div>
