			...
			<div id="page_base">
				...
				<div class="page_base_in">
					<div class="page_base_box">
						<h3>新規クーポンを登録</h3>
						<div class="button_area_2"><a href="coupon_new.php" class="btn_main">クーポンを登録する</a></div>
					</div>
					<div class="page_base_box_2">
						...
						<div class="coupon_page_ticket_box_base">
							<div class="coupon_page_ticket_box">
								...
								<div class="wrapper">
									<div class="element_calendar"><a href="event_edit.php" class="btn_sub">クーポンを編集</a></div>
									<div class="element_calendar"><a data-target="modal1" class="btn_sub modal_open">クーポンを削除</a></div>
								</div>
								<!-- モーダル1 -->
