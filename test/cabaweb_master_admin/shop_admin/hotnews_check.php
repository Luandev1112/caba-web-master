					...
					<div class="page_base_box_2">
						...
						<form action="hotnews_check.php" method="post" id="form" enctype="multipart/form-data">
							<div class="hotnews_photo_area">
								<h3>■画像</h3>
								<img src="" data-src="img/test-2.jpg" class="castphoto_contain_check lozad" />
							</div>
							<p>
								<label>
									<span>■タイトル</span><br />
							...
							<p>
								<label>
									<span>■掲載終了日</span><br />
									<span style="font-size: 80%; color: #4D4D4D;">2020-05-15</span>
								</label>
							</p>
							<p>
								<label>
							...
							<p>
								<label>
									<span>■リンクURL</span><br />
									<span style="font-size: 80%; color: #4D4D4D;">https://www.caba-web.com/</span>
								</label>
							</p>							
