					...
					<div class="page_base_box_2">
						...
						<form action="" method="post" id="form">
							<div class="shopphoto_page_box">
								<p>
									<label><span>ROOM名 ①</span><input type="text" name="ROOM名" class="txtfiled" placeholder="例）Main Room"></label>
								</p>
								<table>
									<tr>
							...
							<div class="shopphoto_page_box_2">
								<p>
									<label><span>ROOM名 ②</span><input type="text" name="ROOM名" class="txtfiled" placeholder="例）VIP Room"></label>
								</p>
								<table>
									<tr>
										<td class="t_castgallery">
							...
							<div class="shopphoto_page_box_2">
								<p>
									<label><span>ROOM名 ③</span><input type="text" name="ROOM名" class="txtfiled" placeholder="例）EXECUTIVE Room"></label>
								</p>
								<table>
									<tr>
										<td class="t_castgallery">
							...
							<div class="shopphoto_page_box_2">
								<p>
									<label><span>ROOM名 ④</span><input type="text" name="ROOM名" class="txtfiled" placeholder="例）KARAOKE Room"></label>
								</p>
								<table>
									<tr>
										<td class="t_castgallery">
