									...
									<div class="top_cast_box_button">
										...
										<div class="top_cast_box_button_a">
											<div class="todayscast_box_2">
												<p><input type="radio" name="radio_1" class="radio-input_2" id="radio-02" value="出勤"><label for="radio-02">出勤</label></p>
											</div>
										</div>
										<div class="clear"></div>
										<div class="top_cast_box_button_b">
											<div class="todayscast_box_2">
												<p><input type="radio" name="radio_1" class="radio-input_2" id="radio-02-2" value="出勤"><label for="radio-02-2">出勤（時間付き）</label></p>
							...
							<div class="element_cast">
								<div class="top_cast_box">
									...
									<div class="top_cast_box_button">
										...
										<div class="top_cast_box_button_a">
											<div class="todayscast_box_2">
												<p><input type="radio" name="radio_2" class="radio-input_2" id="radio-04" value="出勤"><label for="radio-04">出勤</label></p>
											</div>
										</div>
										<div class="clear"></div>
										<div class="top_cast_box_button_b">
											<div class="todayscast_box_2">
												<p><input type="radio" name="radio_2" class="radio-input_2" id="radio-04-2" value="出勤"><label for="radio-04-2">出勤（時間付き）</label></p>
												<p style="padding-top: 5px;">
													<select name="開始時間">
														<option value="18:00">18:00</option>
														<option value="18:30">18:30</option>
							...
							<div class="element_cast">
								<div class="top_cast_box">
									...
									<div class="top_cast_box_button">
										...
										<div class="top_cast_box_button_a">
											<div class="todayscast_box_2">
												<p><input type="radio" name="radio_3" class="radio-input_2" id="radio-06" value="出勤"><label for="radio-06">出勤</label></p>
											</div>
										</div>
										<div class="clear"></div>
										<div class="top_cast_box_button_b">
											<div class="todayscast_box_2">
												<p><input type="radio" name="radio_3" class="radio-input_2" id="radio-06-2" value="出勤"><label for="radio-06-2">出勤（時間付き）</label></p>
												<p style="padding-top: 5px;">
													<select name="開始時間">
														<option value="18:00">18:00</option>
														<option value="18:30">18:30</option>
