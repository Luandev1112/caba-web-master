				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<form action="mail2.php" method="post" id="form">
							...
							<p>
								<label><span>メールアドレス（<font color="#FF0000">必須</font>）</span><input type="email" name="メールアドレス" style="ime-mode:disabled;" class="txtfiled" placeholder="info@caba-web.com" required></label>
							</p>
							<p>
