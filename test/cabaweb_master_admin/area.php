						...
						<div class="wrapper">
							<div class="element_arealist">
								<div class="top_news_box">
									<div class="client_area">群馬県</div>
									<div class="client_shop">高崎市</div>
									<div class="wrapper">
										<div class="element_news_a"><a href="area_edit.php" class="btn_sub">編集</a></div>
									...
									<div id="modal_delete_1" class="modal_box">
										<p>
										<div class="modal_box_title">エリアを削除</div>
