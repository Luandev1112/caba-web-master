...
<div class="page_base_area">
  <div class="page_base">
    ...
    <br />
    第２条(本業務) <br />
    乙が甲に提供する業務は次の通りとする。但し、第３条に定める仕様書において本契約と異なる事項を定めた場合は、その部分について仕様書を優先する。<br />
    ...
    <br />
    第１１条（アフターサービス）<br />
    甲及び甲の顧客に対する本制作物のアフターサービス（何ら瑕疵のない本制作物について、甲がさらに変更・修正が必要と判断する場合の変更・修正業務を含む。）は、甲の費用をもって甲が行なうものとする。 尚、変更・修正費用は５０００円からとし乙が定める料金となる。<br />
    <br />
    第１２条（著作権）<br />
    ...
    <p>
    <label><span>代表者名（<font color="#FF0000">必須</font>）</span><input type="text" name="代表者名" class="txtfiled" placeholder="例）きゃば 太郎" required></label>
    </p>
    <p>
    <label><span>ふりがな（<font color="#FF0000">必須</font>）</span><input type="text" name="ふりがな" class="txtfiled" placeholder="例）きゃば たろう" required></label>
    </p>   
    <p>
    <label><span>代表者携帯番号（<font color="#FF0000">必須</font>）</span><input type="tel" name="代表者携帯番号" style="ime-mode:disabled;" class="txtfiled" placeholder="例）09000000000" required></label>
    </p>
    <p>
    <label><span>住所（<font color="#FF0000">必須</font>）</span><input type="tel" name="住所" style="ime-mode:disabled;" class="txtfiled" placeholder="例）群馬県前橋市天川大島町" required></label>
    </p>
    <p>
    <label><span>店舗電話番号（<font color="#FF0000">必須</font>）</span><input type="tel" name="店舗電話番号" style="ime-mode:disabled;" class="txtfiled" placeholder="例）0270000000" required></label>
    </p>
    <p>
    <label><span>メールアドレス（<font color="#FF0000">必須</font>）</span><input type="text" name="メールアドレス" class="txtfiled" placeholder="例）info@caba-web.com" required></label>
    </p>
    <p>
    <span>
    ...
    <input type="checkbox" name="同意する" value="同意する" required>同意する   
    </label>
    </p>               
    ...
    <div class="g-recaptcha" data-sitekey="6Leio4wUAAAAAJcmAa5RO9JO0bphpD_dhFXD2EuV"></div>
...
$secret_key = '6Leio4wUAAAAACTKnZCGroRrFE6lWUASt7QBqrW6' ;

// google reCAPTCHAにsecret keyなどを送って、不正なくチェックなどされているかどうかを判断してもらう
//（https://developers.google.com/recaptcha/docs/verify などを参照）
$response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Leio4wUAAAAACTKnZCGroRrFE6lWUASt7QBqrW6&response={$_POST['g-recaptcha-response']}");
