...
//		array_splice($data , $i , 1 , $line);
		mysqli_query($sql2, "UPDATE `data` SET `name`='$name',`name2`='$name2',`profinfo9`='$profinfo9',`profinfo10`='$profinfo10',`profinfo11`='$profinfo11',`profinfo12`='$profinfo12',`option2`='$option2',`option3`='$option3',`option4`='$option4',`option5`='$option5',`option10`='$option10' WHERE `name2` LIKE '$name2' LIMIT 1");
