...
<div class="page_base_in">  
  ...
  <!--div class="contact_page_base">    
    ...
    <p>
    <label><span>メールアドレス（<font color="#CC0000">必須</font>）</span><input type="email" name="メールアドレス" style="ime-mode:disabled;" class="txtfiled" placeholder="info@caba-web.com" required></label>
    </p>         
    <p>
