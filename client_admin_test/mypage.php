...
<div class="page_base_in">  
  ...
  <div class="mypage_page_base_2">
    ...
    <div class="mypage_naiyou">
    <span style="color: #00F">入金済</span><br />
    <span style="color: #F00">未入金</span><br />
    <span style="color: #C60">請求済み</span><br />
    </div>                    
    ...
    <div class="mypage_naiyou">
    <span style="color: #F93">更新 残りあと1枚</span><br />
    <span style="color: #F93">更新 残りあと2枚</span><br />
    <span style="color: #F00">更新済</span><br />
    <span style="color: #00F">未更新</span><br />    
    </div>
    ...
    <div class="mypage_naiyou">
    <span style="color: #00F">未契約</span><br />
    <span style="color: #F00">契約中</span><br />
    </div>
