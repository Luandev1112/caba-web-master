        ...
        <div id="shop_event">
          <table class="event_t">
            ...
            <tr class="cmt2">
              <td class="data">2</td>
              <td class="naiyou">
              <div class="calendar_page_icon" style="color: #F69;">誕生日</div>
            ...
            <tr class="event sun">
              <td class="data">4</td>
              <td class="naiyou">
              <div class="calendar_page_icon" style="color: #C00;">店休日</div>
            ...
            <tr class="cmt2">
              <td class="data">5</td>
              <td class="naiyou">
              <div class="calendar_page_icon" style="color: #39F;">イベント</div>
