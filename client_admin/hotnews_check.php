...
<html lang="ja"><head>
<meta charset="utf-8">
<title>新規ホットニュース登録確認｜Admin Tool</title>
<meta name="description" content="管理画面ツール　新規ホットニュース登録確認">
...
<div class="page_base_in">
  ...
  <div class="page_base_box_2">
    ...
    <form action="hotnews_write.php" method="post" id="form">
...
//fclose($handle);
mysqli_query($sql, "UPDATE `news` SET `photo1`='$photo1' WHERE `news_id` LIKE '$news_id' LIMIT 1");
...
?>
    ...
    <p>
    <label><span>掲載終了日（<font color="#CC0000">必須</font>）</span><?php echo $start; ?><br />
    <span style="font-size:60%; color:#FF6666;">設定した日付を過ぎると自動的に削除されます。</span>
    </label>
    </p>
    <p>
    <label><span>内容（<font color="#CC0000">必須</font>）</span><?php echo $input; ?></label>
    </p>
