...
<div class="page_base_in">
  ...
  <h3>新規クーポン登録</h3>
    <div class="todayscast_button"><a href="coupon_new.php?shop_id=<?php echo $shop_id; ?>" class="btn_2">クーポンを登録</a></div> 
  </div>
  ...
  <div class="coupon_page_box">
	  <?php
  $result=mysqli_query($sql, "SELECT * From `coupon` WHERE coupon_shop='$shop_id' ORDER by coupon_id DESC");
...
echo "<div class=\"news_button_box\">
      <div class=\"top_cast_box_button_a\">
        <a href=\"coupon_edit.php?coupon_id=".$coupon_id."\" class=\"btn_1\">クーポンを編集</a>
      </div>
      <div class=\"top_cast_box_button_a\">
        <a data-target=\"modal_news_".$coupon_id."\" class=\"btn_1 modal_open\">クーポンを削除</a>
      </div>
      <div class=\"clear\"></div>\n";

echo "<div id=\"modal_news_".$coupon_id."\" class=\"modal_box\">          
          <p>
            <div class=\"castschedule_modal_box_title\">クーポンを削除</div>
            <div class=\"cast_sakujyo\">本当に削除しますか？</div>
            <div class=\"todayscast_button\"><a href=\"coupon_rewrite2.php?coupon_id=".$coupon_id."\" class=\"btn_2\">削除する</a></div>
          </p>
