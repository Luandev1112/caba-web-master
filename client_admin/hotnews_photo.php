      ...
      <tr>
        <td class="t_hot">
          <div class="castphoto_number">ホットニュース画像</div>
			<?php
if ($photo1 == $empty) {
	echo '<img src="photo/nophoto_1.jpg" class="castphoto_contain" />';
} else {
	if($photo_box == '1'){
	echo "<img src=\"https://www.caba-web.com/client_admin/".$photo1.".jpg\" alt=\"".$name."\" class=\"castphoto_contain\" />\n";
}elseif($photo_box == '2'){
	echo "<img src=\"https://www.caba-lab.com/master_admin/".$photo1.".jpg\" alt=\"".$name."\" class=\"castphoto_contain\" />\n";
}elseif($photo_box == ''){
	echo "<img src=\"https://www.caba-web.com/client_admin/".$photo1.".jpg\" alt=\"".$name."\" class=\"castphoto_contain\" />\n";
}
}
?>
        ...
        <td class="t_hot-2">
          ...
          <label>
            <input type="checkbox" name="delete1" value="delete" />削除する
          </label>
          </div>
        </td>
      </tr>                                                          
