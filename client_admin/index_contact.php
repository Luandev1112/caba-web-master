...
<html lang="ja"><head>
<meta charset="utf-8">
<title>インデックスからお問合せ｜Admin Tool</title>
<meta name="description" content="管理画面ツール　インデックスからお問合せ">
...
<div class="page_base_in">  
  ...
  <div class="contact_page_base_2">
    ...
    <p>
    <label><span>お問合せ内容（<font color="#CC0000">必須</font>）</span>
    <select name="お問合せ内容" required>
    <option value=""></option>
    <option value="IDの紛失">IDのみ紛失</option>
    <option value="パスワードの紛失">パスワードのみ紛失</option>
    <option value="ID・パスワードの紛失">ID・パスワードの紛失</option>      
    </select>
    </label>
    </p>     
    <p>
