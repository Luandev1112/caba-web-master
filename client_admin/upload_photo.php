...
if (($photo_type1 == 'image/jpeg') || ($photo_type1 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		//アップロードの成功
		echo '<a class="media-left media-top" href="' . $upload_name1 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name1. '?' . $koshin . '" alt="photo1"  width="20%" /></a><div class="media-body"><h4 class="media-heading">サムネイル(写真1枚目)</h4>';
...
if (($photo_type2 == 'image/jpeg') || ($photo_type2 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name2 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name2. '?' . $koshin . '" alt="photo2"  width="20%" /></a><div class="media-body"><h4 class="media-heading">写真2枚目</h4>';
...
if (($photo_type3 == 'image/jpeg') || ($photo_type3 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name3 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name3. '?' . $koshin . '" alt="photo3" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真3枚目</h4>';
...
if (($photo_type4 == 'image/jpeg') || ($photo_type4 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name4 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name4. '?' . $koshin . '" alt="photo4" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真4枚目</h4>';
...
if (($photo_type5 == 'image/jpeg') || ($photo_type5 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name5 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name5. '?' . $koshin . '" alt="photo5" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真5枚目</h4>';
...
if (($photo_type6 == 'image/jpeg') || ($photo_type6 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name6 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name6. '?' . $koshin . '" alt="photo6" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真6枚目</h4>';
...
if (($photo_type7 == 'image/jpeg') || ($photo_type7 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name7 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name7. '?' . $koshin . '" alt="photo7" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真7枚目</h4>';
...
if (($photo_type8 == 'image/jpeg') || ($photo_type8 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name8 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name8. '?' . $koshin . '" alt="photo8" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真8枚目</h4>';
...
if (($photo_type9 == 'image/jpeg') || ($photo_type9 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name9 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name9. '?' . $koshin . '" alt="photo4" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真9枚目</h4>';
...
if (($photo_type10 == 'image/jpeg') || ($photo_type10 == 'image/pjpeg')) {
	...
	if ($result) {
		...
		echo '<a class="media-left media-top" href="' . $upload_name10 . '?' . $koshin . '" target="_blank"><img src="' . $upload_name10. '?' . $koshin . '" alt="photo10" width="20%" /></a><div class="media-body"><h4 class="media-heading">写真10枚目</h4>';
...
//fclose($handle);
mysqli_query($sql, "UPDATE `data` SET `option11`='$option11',`photo1`='$photo1', `photo2`='$photo2', `photo3`='$photo3', `photo4`='$photo4', `photo5`='$photo5', `photo6`='$photo6', `photo7`='$photo7', `photo8`='$photo8', `photo9`='$photo9', `photo10`='$photo10' WHERE `name2` LIKE '$name2' LIMIT 1");
