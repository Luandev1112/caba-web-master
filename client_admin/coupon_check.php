...
<div class="page_base_in">
  ...
  <div class="page_base_box_2">
    ...
    <p>
    <label><span>クーポン内容（<font color="#CC0000">必須</font>）</span><?php echo $coupon1; ?></label>
    </p>
    <p>
    <label><span>有効期限（<font color="#CC0000">必須</font>）</span><?php echo $coupon2; ?></label>
    </p>
     <p>
    <label><span>注意事項（<font color="#CC0000">必須</font>）</span><?php echo $coupon3; ?></label>
    </p>   
