...
//		array_splice($data , $i , 1 , $line);
		mysqli_query($sql, "UPDATE `news` SET `news_id`='$news_id',`start`='$start',`sort`='$sort',`end`='$end',`sort2`='$sort2',`time`='$time',`newstitle`='$newstitle',`input`='$input',`photo1`='$photo1',`jpeg`='$jpeg',`link`='$link',`blank`='$blank',`hotnews`='$hotnews',`photo_box`='$photo_box',`n_area`='$n_area',`n_area2`='$n_area2',`n_gyoushu`='$n_gyoushu',`n_link`='$n_link',`news_no`='$news_no',`sort_order`='$sort_order' WHERE `news_id` LIKE '$news_id' LIMIT 1");
