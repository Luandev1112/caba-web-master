					...
					<div class="page_base_box_2">
						...
						<form action="" method="post" id="form">
							...
							<div class="cast_touroku_area">
								<h3>SNS</h3>
								<p>
									<label><span>Instagram URL</span><input type="url" name="Instagram URL" class="txtfiled" placeholder="例）Instagram URL"></label>
								</p>
								<p>
									<label><span>Instagram RSS</span><input type="url" name="Instagram RSS" class="txtfiled" placeholder="例）Instagram RSS"></label>
								</p>
								<p>
									<label><span>You Tube URL</span><input type="url" name="You Tube URL" class="txtfiled" placeholder="例）You Tube URL"></label>
								</p>
								<p>
									<label><span>You Tube RSS</span><input type="url" name="You Tube RSS" class="txtfiled" placeholder="例）You Tube RSS"></label>
								</p>
								<p>
									<label><span>Twitter URL</span><input type="url" name="Twitter URL" class="txtfiled" placeholder="例）Twitter URL"></label>
								</p>
								<p>
									<label><span>Tik Tok URL</span><input type="url" name="Tik Tok URL" class="txtfiled" placeholder="例）Tik Tok URL"></label>
								</p>																
							</div>
