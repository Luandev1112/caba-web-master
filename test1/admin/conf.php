...
//「''」内を変更。IDとパスワード設定
$login_id = 'caba-lab';	//ログインID
$login_pass = 'master-lab';	//ログインパスワード
...
//「''」内を変更
$sql_server = 'mysql139.phy.lolipop.lan';	/* SQLサーバアドレス */
$sql_database = 'LAA0219176-portaltest';	/* SQLデータベース名 */
...
$sche_days = date("Ymd", strtotime("-5 hour"));
