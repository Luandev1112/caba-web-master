			...
			<div id="page_base">
				...
				<div class="page_base_in">
					<div class="page_base_box_2">
						...
						<form action="information_rewrite3.php" method="post" id="form" enctype="multipart/form-data"><input type="hidden" name="info_id" value="<?php echo $info_id; ?>" />
...
<input type="hidden" name="info_blank" value="<?php echo $info_blank; ?>" />
							...
							<p>
								<label>
									<span>内容（<font color="#FF0000">必須</font>）</span><?php $info_text = str_replace("<br />" , "\r\n" , $info_text); ?><textarea name="info_text" class="txtfiled" rows="10" placeholder="例）新規掲載しました♪" required><?php echo $info_text; ?></textarea><br />
