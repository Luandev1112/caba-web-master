			...
			<div id="page_base">
				...
				<div class="page_base_in">
					<div class="page_base_box">
						<h3>新規クーポンを登録</h3>
						<div class="button_area_2"><a href="coupon_new.php?no=<?php echo $no; ?>" class="btn_main">クーポンを登録する</a></div>
					</div>
					<div class="page_base_box_2">
						...
						<?php
  $result=mysqli_query($sql3, "SELECT * From `coupon` WHERE coupon_shop='$data5' AND `coupon2` >=$news_today ORDER by coupon_id DESC");
...
echo "<div id=\"modal".$coupon_id."\" class=\"modal_box\">          
          <p>
            ...
            <div class=\"under_button_area_2\"><a href=\"coupon_rewrite2.php?coupon_id=".$coupon_id."&no=".$no."\" class=\"formbtn_2\">削除する</a></div>
          </p>
