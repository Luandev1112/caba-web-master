...
<body>
	...
	<div class="drawer drawer--left">
		...
		<div id="page_base">
			<h2><?php echo $s_name; ?><br /><span style="font-size: 70%;">ニュース並び替え</span></h2>
...
jQuery(function($) {
	$("#news_sort").sortable({ 
		...
		stop : function(){
			var data=[];
			$("li","#news_sort").each(function(i,v){
				data.push(v.id);
			});
		...
		update : function(){
			$('#submit').removeAttr('disabled');
					...
					<ul id="news_sort">
						<?php
$result=mysqli_query($sql2, "SELECT * From `news` WHERE (sort>='$news_today' or sort='') AND blank='$login_id' AND link='1' ORDER by sort_order");
